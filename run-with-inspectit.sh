...
CONFIGURATION_FILE=/root/Oracle/Middleware/user_projects/domains/base_domain/bin/startWebLogic.sh
...
exec ./user_projects/domains/base_domain/bin/startWebLogic.sh
